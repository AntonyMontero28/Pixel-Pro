...
if(isset($_POST['id']) && isset($_POST['estado'])){
    ...
    // Actualizar estado con prepared statement
    ...
    if($estado=="Impreso"){
        ...
        // Nota: mail() requiere servidor de correo configurado (XAMPP no lo envía por defecto)
        $to = $pedido['correo'];
        ...
        // mail($to,$subject,$message,$headers); // Descomentar si tienes servidor de correo
    }
}
